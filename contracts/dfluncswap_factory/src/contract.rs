use classic_dfluncswap::querier::{query_balance, query_pair_info_from_pair};
...
use classic_dfluncswap::asset::{Asset, AssetInfo, AssetInfoRaw, PairInfo, PairInfoRaw};
use classic_dfluncswap::factory::{
...
use classic_dfluncswap::util::migrate_version;
use protobuf::Message;

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:dfluncswap-factory";
...
pub fn instantiate(
    ...
    let config = Config {
        ...
        lp_stake_contract: deps.api.addr_canonicalize(msg.lp_stake_contract.as_str())?,
...
pub fn execute(
    ...
    match msg {
        ExecuteMsg::UpdateConfig {
            ...
            lp_stake_contract,
            fee_rate
        } => execute_update_config(deps, env, info, owner, token_code_id, pair_code_id, lp_stake_contract, fee_rate),
...
pub fn execute_update_config(
    ...
    lp_stake_contract: Option<String>,
    fee_rate: Option<u64>,
) -> StdResult<Response<TerraMsg>> {
    ...
    if let Some(lp_stake_contract) = lp_stake_contract {
        config.lp_stake_contract = deps.api.addr_canonicalize(&lp_stake_contract)?;
    }
        ...
        .add_submessage(SubMsg {
            ...
            msg: CosmosMsg::Wasm(WasmMsg::Instantiate {
                ...
                msg: to_binary(&PairInstantiateMsg {
                    ...
                    asset_decimals,
                    lp_stake_contract: deps.api.addr_humanize(&config.lp_stake_contract)?.to_string(),
...
pub fn reply(deps: DepsMut<TerraQuery>, env: Env, msg: Reply) -> StdResult<Response<TerraMsg>> {
    ...
    PAIRS.save(
        ...
        &PairInfoRaw {
            ...
            lp_stake_contract: deps.api.addr_canonicalize(&pair_info.lp_stake_contract)?,
            fee_rate: pair_info.fee_rate,
        },
    )?;
