...
use classic_dfluncswap::mock_querier::{mock_dependencies, WasmMockQuerier};

use crate::state::{pair_key, TmpPairInfo, TMP_PAIR_INFO};

use classic_dfluncswap::asset::{Asset, AssetInfo, PairInfo};
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        ...
        lp_stake_contract: "addr0000".to_string(),
        fee_rate: 3000,
    };
...
fn update_config() {
    ...
    let msg = ExecuteMsg::UpdateConfig {
        ...
        pair_code_id: None,
        token_code_id: None,
        lp_stake_contract: Some("addr0001".to_string()),
        fee_rate: None,
    };
    ...
    let msg = ExecuteMsg::UpdateConfig {
        ...
        lp_stake_contract: None,
        fee_rate: Some(3000u64),
    };
        ...
        vec![SubMsg {
            ...
            msg: WasmMsg::Instantiate {
                msg: to_binary(&PairInstantiateMsg {
                    ...
                    lp_stake_contract: "lpstaker000".to_string(),
                    fee_rate: 0u64,
                })
                .unwrap(),
                code_id: 321u64,
